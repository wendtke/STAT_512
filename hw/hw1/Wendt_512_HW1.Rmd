...
For every one-unit increase in antibiotics in cattle feed, there is a four-day decrease in time to market weight, holding all other variables (i.e., protein, supplements) constant.
...
Working from the “full” model, test the null hypothesis that the partial regression coefficient for Protein equals -3.0 versus a two-sided alternative. In other words, test H0: beta1 is -3 versus HA: beta1 is not -3. Give a test statistic, p-value and conclusion. (4 pts) 
...
We reject the null hypothesis that the partial regression coefficient for protein is equal to -3. There is evidence to suggest it is not equal to -3, _F_ = `r protein_alt$statistic[2]`, _p_ = `r protein_alt$p.value[2]`. 
