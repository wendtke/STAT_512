...
car::Anova(bio_ancova_int, type = 3)
...
```{r bio_ancova_alt}
# 4. build alternate parameterization
bio_ancova_alt <- lm(fisher_alpha ~ age + age*ppt - 1, data = bio_data)
summary(bio_ancova_alt)

# OR ?? check Canvas discussion
summary(bio_ancova_int)
```
