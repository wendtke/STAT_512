...
Create a bar chart (with SE bars) to summarize the data. Include the resulting graph in your assignment. Assuming your summary table from above is called `SumStats` (with columns `Method`, `mean` and `se`), you can use code something like this:
...
## Question C: RCB model & assumptions
